-- Aventra Property Management Silo — Unified Multi-Tenant Auth Schema
...
create table if not exists public.profiles (
  ...
  notification_preferences jsonb not null default '{"rent_alert":true,"compliance_alert":true}'::jsonb,
  created_at timestamptz not null default now()
);
