...
export const metadata: Metadata = {
  title: 'Create Account — Aventra Deal Engine',
  description: 'Get started with Aventra and access your AI-powered real estate deal engine.',
}
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Get started with Aventra today</p>
        </div>
