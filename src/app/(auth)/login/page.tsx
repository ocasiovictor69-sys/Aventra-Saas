...
export const metadata: Metadata = {
  title: 'Sign In — Aventra Deal Engine',
  description: 'Sign in to your Aventra account to access your real estate deal engine.',
}
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Sign in to Aventra</h1>
