...
export default function SettingsPage() {
  ...
  const notificationItems = [
    { key: 'lease_expiry' as const, label: 'Lease expiration alerts' },
    { key: 'maintenance'  as const, label: 'Maintenance updates' },
    { key: 'compliance'   as const, label: 'Compliance deadlines' },
  ];
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-slate-600">Manage your AVENTRA account preferences</p>
      </div>
      ...
      <div className="divide-y divide-slate-200 rounded-xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-6 bg-white">
          ...
          <p className="text-sm text-slate-500 mb-4">Control when and how you receive alerts</p>
          <div className="space-y-3">
