    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-600">Overview of your property portfolio</p>
        </div>
        <Link href="/dashboard/properties/new" className="px-4 py-2 bg-brand-purple text-white rounded-lg hover:opacity-90">
          + New Property
        </Link>
      </div>
